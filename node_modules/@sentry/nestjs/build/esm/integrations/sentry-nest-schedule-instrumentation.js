...
import { SDK_VERSION, withIsolationScope, captureException, isThenable } from '@sentry/core';

const supportedVersions = [">=2.0.0"];
const COMPONENT = "@nestjs/schedule";
class SentryNestScheduleInstrumentation extends InstrumentationBase {
  constructor(config = {}) {
...
export { SentryNestScheduleInstrumentation };
