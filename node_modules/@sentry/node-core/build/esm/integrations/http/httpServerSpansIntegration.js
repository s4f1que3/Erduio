...
import { RPCType, setRPCMetadata, getRPCMetadata } from '@opentelemetry/core';
import { NET_HOST_IP, NET_HOST_PORT, NET_PEER_IP, HTTP_STATUS_CODE, HTTP_ROUTE, HTTP_RESPONSE_STATUS_CODE } from '@sentry/conventions/attributes';
import { debug, parseStringToURLObject, stripUrlQueryAndFragment, httpHeadersToSpanAttributes, SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN, SEMANTIC_ATTRIBUTE_SENTRY_OP, getSpanStatusFromHttpCode, SPAN_STATUS_ERROR, isTracingSuppressed, getIsolationScope } from '@sentry/core';
