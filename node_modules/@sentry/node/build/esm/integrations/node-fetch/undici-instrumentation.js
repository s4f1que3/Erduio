...
import { URL } from 'url';
import { LRUMap, debug, stripDataUrlContent, SEMANTIC_ATTRIBUTE_SENTRY_CUSTOM_SPAN_NAME, startInactiveSpan, SPAN_KIND, SPAN_STATUS_ERROR, getClient, shouldPropagateTraceForUrl, withActiveSpan, getTraceData, SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN } from '@sentry/core';
...
function injectTracePropagationHeaders(span, request, url) {
