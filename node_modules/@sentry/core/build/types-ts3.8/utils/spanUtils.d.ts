...
import { SpanLink, SpanLinkJSON } from '../types/link';
import { SerializedStreamedSpan, Span, SpanAttributes, SpanJSON, SpanTimeInput, StreamedSpanJSON } from '../types/span';
import { SpanStatus } from '../types/spanStatus';
 ...
 */
export declare function getSimpleStatus(status: SpanStatus | undefined): 'ok' | 'error';
/**
 ...
 */
export declare function addStatusMessageAttribute(attributes: SpanAttributes, status: SpanStatus | undefined): RawAttributes<Record<string, unknown>>;
