...
import { Breadcrumb, BreadcrumbHint, FetchBreadcrumbHint, XhrBreadcrumbHint } from './types/breadcrumb';
import { CheckIn, MonitorConfig } from './types/checkin';
import { EventDropReason, Outcome } from './types/clientreport';
import { DataCategory } from './types/datacategory';
import { DsnComponents } from './types/dsn';
import { DynamicSamplingContext, Envelope } from './types/envelope';
...
import { ParameterizedString } from './types/parameterize';
import { ReplayEndEvent, ReplayStartEvent } from './types/replay';
...
import { Span, SpanAttributes, SpanContextData, StreamedSpanJSON } from './types/span';
import { StartSpanOptions } from './types/startSpanOptions';
import { Transport, TransportMakeRequestResponse } from './types/transport';
